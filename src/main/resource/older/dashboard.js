...
function getPetById(id){
    ajaxRequest("http://localhost:8080/secure/pet/getPetById/" + id, "GET", null).then((response) => {
        $("#petBody").empty();
        // console.log(response);
        petResponseToTable([response]);
    });
...
function addNewPet(newPet){
    ...
    ajaxRequest("http://localhost:8080/secure/pet/newPet", "POST", newPet).then((response) => {
       console.log(response);
    });
}
...
function updatePet(updatedPet){
    ajaxRequest("http://localhost:8080/secure/pet/updatePet/" + updatedPet.petId, "PUT", updatedPet).then((response) => {
        console.log(response);
    });
}
...
function deletePet(id){
    ajaxRequest("http://localhost:8080/secure/pet/deletePet/" + id, "DELETE", null).then((response) => {
        console.log(response);
    });
}
...
function getUserById(id){
    ajaxRequest("http://localhost:8080/secure/user/getUserById/" + id, "GET", null).then((response) => {
        $("#userBody").empty();
        userResponseToTable([response]);
    });
}
...
function addNewUser(newUser){
    ajaxRequest("http://localhost:8080/secure/user/newUser", "POST", newUser).then((response) => {
       console.log(response);
    });
}
...
function updateUser(updatedUser){
    ajaxRequest("http://localhost:8080/secure/user/updateUser/" + updatedUser.id, "PUT",updatedUser)
        .then((response) => {
           console.log(response);
        });
}
...
function deleteUser(id){
    ajaxRequest("http://localhost:8080/secure/user/deleteUser/" + id, "DELETE", null).then((response) => {
        console.log(response);
    });
}
